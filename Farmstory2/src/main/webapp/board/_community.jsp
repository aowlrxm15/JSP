            ...
            <section class="cate5">
                <aside>
                    ...
                    <ul class="lnb">
                        ...
                        <li class="${cate eq 'menu'?'on':'off'}"><a href="/Farmstory2/board/list.do?group=community&cate=menu">공지사항</a></li>
                        <li class="${cate eq 'chef'?'on':'off'}"><a href="/Farmstory2/board/list.do?group=community&cate=chef">공지사항</a></li>
                        <li class="${cate eq 'qna'?'on':'off'}"><a href="/Farmstory2/board/list.do?group=community&cate=qna">공지사항</a></li>
                        <li class="${cate eq 'faq'?'on':'off'}"><a href="/Farmstory2/board/list.do?group=community&cate=faq">공지사항</a></li>
                    </ul>
                </aside>
                <article>
                    <nav>
                        <img src="/Farmstory/img/sub_nav_tit_cate5_${cate}.png" alt="공지사항"/>
                        <p>
                            HOME > 커뮤니티 >
                            <c:if test="${cate eq 'notice'}"><em>농작물이야기</em></c:if>
