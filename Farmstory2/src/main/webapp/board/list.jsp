    ...
    <section class="list">                
        ...
        <table border="0">
            ...
            <tr>
                ...
                <td><a href="/Farmstory2/board/view.do?group=${group}&cate=${cate}">${article.title}[${article.comment}]</a></td>
                <td>${article.nick}</td>
        ...
        <div class="page">
            ...
            <c:forEach var="i" begin="${pageGroupStart}" end="${pageGroupEnd}">
            	<a href="/Farmstory2/board/list.do?pg=${i}&search=${search}" class="num ${currentPage == i?'current':'off'}">${i}</a>
            </c:forEach>
