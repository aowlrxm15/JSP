...
<main id="user">
    <section class="register">
        <form action="/Farmstory1/user/register.do" method="post">
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" id="btnIdCheck"><img src="/Farmstory1/user/img/chk_id.gif" alt="중복확인"/></button>
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" onclick="zipcode()"><img src="/Farmstory1/user/img/chk_post.gif" alt="우편번호찾기"/></button>
            ...
            <div>
                <a href="/Farmstory1/user/login.do" class="btn btnCancel">취소</a>
